...
require 'PHPMailer/src/SMTP.php';
    ...
    try {
        ...
        $mail->addAddress('its.tcd.marketing@gmail.com');     // Add a recipient
        ...
        $mail->Subject = "[Tech Career Days] NEW RESUME SUBMIT SUCCESS ".$email;
        $mail->Body    = $email.' has submitted a new resume, check <a href="https://tcd2021-committee.herokuapp.com/">HERE</a> to execute vetting.<br> This is an automated email.<br>Thank you.';

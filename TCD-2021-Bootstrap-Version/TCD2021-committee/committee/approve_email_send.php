...
require 'PHPMailer/src/SMTP.php';
    ...
    try {
        ...
        $mail->Subject = "[Tech Career Days] Your Resume Is Approved! Are you ready?";
        $mail->Body    = "Hey there,
        <br><br>
        Congratz! Your resume looks great and is now made available for the recruiters to peruse.
        <br><br>
        Thanks,<br>
        Tech Career Days 2021, presented by IT Society";
